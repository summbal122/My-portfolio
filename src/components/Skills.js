...
export default function Skills() {
  return (
    <section id="skills" className="py-8 lg:py-20 flex justify-center bg-white">
      <div className="text-center px-4 lg:px-0 lg:w-10/12">
        <h2 className="text-2xl lg:text-4xl font-serif font-semibold text-gray-800 mb-6 lg:mb-12">
          Technical Skills
        </h2>

        <div className="grid md:grid-cols-3 gap-6 lg:gap-10 text-start">
