      ...
      <div className="relative h-40 md:h-60 overflow-hidden group">
       ...
       <div className="px-3 md:px-6 py-3 md:py-4 flex flex-col flex-grow">
        ...
        <div className="block lg:hidden">
            ...
            <a href={demoLink} target="_blank" rel="noopener noreferrer"
            className="flex text-sm items-center gap-2 bg-white  text-black px-4 py-2 rounded-full shadow-lg hover:scale-105 transition hover:cursor-pointer" >
              <ExternalLink size={15} /> Live Demo
            </a>
            <a href={githubLink} target="_blank" rel="noopener noreferrer"
              className="flex text-sm items-center gap-2 bg-black text-white px-4 py-2 rounded-full shadow-lg hover:scale-105 transition hover:cursor-pointer">
