...
export default function Footer() {
  return (
    <footer id="contact" className="w-full bg-gradient-to-r from-gray-50 to-gray-100 text-black pt-6 lg:pt-10">
      <div className="w-11/12 md:w-9/12 mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-20">
        ...
        <div className="md:col-span-6 flex flex-col justify-center">
          ...
          <p className="text-gray-600 text-sm md:text-base mb-4 lg:mb-6 leading-relaxed">
        ...
        <form className="md:col-span-6 flex flex-col gap-2 lg:gap-4 bg-white p-4 lg:p-6 rounded-2xl lg:shadow-xl border border-gray-200">
          <h2 className="text-xl lg:text-2xl font-semibold font-serif text-center mb-1 lg:mb-4 text-gray-800">
            Contact Me
          </h2>
          ...
          <button type="submit" className="bg-golden-yellow text-black font-medium px-6 py-2 lg:py-3 rounded-lg shadow-md hover:bg-golden-yellow/80 transition duration-300 hover:cursor-pointer">
            Send Message
          </button>
        </form>
      </div>
