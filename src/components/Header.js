...
export default function Header (){
  return(
    <div className="w-full flex justify-between items-center px-2 md:px-20 lg:px-40 py-2 lg:py-3 text-bg-primary">
     <h1 className="hidden md:block text-lg md:text-2xl lg:text-3xl tracking-widest font-bold">SI </h1>
     <ul className="flex text-xs lg:text-sm p-4 gap-4 lg:gap-7 tracking-wider font-thick">
     ...
     <button className="bg-bg-primary text-xs lg:text-sm text-white px-4 py-1.5 md:py-2 rounded-lg hover:cursor-pointer hover:bg-bg-primary/90"><Link smooth={true} duration={500} spy={true} to="contact">Get In Touch</Link></button>
